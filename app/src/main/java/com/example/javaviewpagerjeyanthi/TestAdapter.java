...
public class TestAdapter extends RecyclerView.Adapter<TestAdapter.ViewHolder> {
    ...
    String TAG = TestAdapter.class.getSimpleName();
    Context context;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.text_holder, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvQuotes.setText(Html.fromHtml(quotes[position]).toString());
    ...
    public int getItemCount() {
        ...
        Log.d(TAG, "----->getItemCount" + quotes.length);
    ...
    class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            tvQuotes = itemView.findViewById(R.id.textView3);
        }
    }
}
